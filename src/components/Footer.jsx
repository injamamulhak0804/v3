...
const Footer = () => {
  return (
    <>
       <div className='font-fira fixed bottom-0 flex text-[#607B96] bg-[#011627] w-full border-t items-center border-[#1E2D3D] justify-between text-sm  md:px-10 h-7'>
          <div className='flex items-center justify-center'>
              ...
              <div className='flex items-center'>
                ...
                <p className='md:pt-2 cursor-pointer text-md px-4 border-e border-[#1E2D3D]'><FaXTwitter /></p>
                </a>
                <a target="_blank" href="https://www.instagram.com/mr.brad_ford/">
                  <p className='md:pt-2 cursor-pointer text-md  px-4 border-e border-[#1E2D3D]'><FaInstagram /></p>
                </a>
                <a target="_blank" href="https://www.instagram.com/mr.brad_ford/">
                  <p className='md:pt-2 cursor-pointer text-md  px-4 border-e border-[#1E2D3D]'><FaGithubAlt /></p>
                </a>
              </div>
          </div>
          <div>
